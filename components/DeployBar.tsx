...
export default function DeployBar({ onDeploy }: DeployBarProps) {
  ...
  return (
    <div className="z-10 absolute bottom-3 md:bottom-2 w-full max-w-xl px-4 md:px-6 safe-area-bottom">
      <form onSubmit={handleSearch} className="flex w-full pointer-events-auto shadow-[0_0_30px_rgba(0,229,255,0.2)] rounded-xl md:rounded-2xl bg-black/80 backdrop-blur-xl border border-[#00e5ff]/40 overflow-hidden">
